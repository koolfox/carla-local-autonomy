# CARLA monocular-vision framework development reproduction bundle v0.8 final

Bundle ID: `bundle-framework-development-20260727-v007`  
Purpose: `development`  
Sources: 5 verified research objects  
Source snapshot: 217 files  
Dependency locks: 1
...
9. `uv run carla-verify native_kits/native-host-kit-pilot-20260727-v003 --reject-unregistered`
...
```text
uv run carla-verify-reproduction bundle-framework-development-20260727-v007
uv run carla-verify bundle-framework-development-20260727-v007 --reject-unregistered
```
