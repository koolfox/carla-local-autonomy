# CARLA monocular-vision framework development reproduction bundle

Bundle ID: `bundle-framework-development-20260726-v001`  
Purpose: `development`  
Sources: 10 verified research objects  
Source snapshot: 143 files  
Dependency locks: 1
...
3. `uv run ruff check .`
4. `uv run python -m compileall -q carla_vision carla_yolo`
...
```text
uv run carla-verify-reproduction bundle-framework-development-20260726-v001
uv run carla-verify bundle-framework-development-20260726-v001 --reject-unregistered
```
