...
# Safetensors conversion by SFconvertbot in the original NVIDIA repository,
# https://huggingface.co/nvidia/segformer-b0-finetuned-cityscapes-1024-1024/discussions/4
DEFAULT_SEGFORMER_B0_REVISION = "a8df754056355c08d3d8c9c4f5b5988e4bd2f676"
...
class SegmentationConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if backend not in {"custom", "yolop", "yolopv2"} and (
