...
_EVIDENCE_REGISTRY_ROLES = frozenset(
    {
        "evidence_registry_configuration",
        "evidence_registry_release_manifest",
        "evidence_registry_summary",
        "evidence_registry_object_table",
        "evidence_registry_artifact_table",
        "evidence_registry_report",
        "evidence_registry_checksum_index",
    }
)
...
def _verify_deep(
    ...
    if "dataset_manifest" in role_names:
        ...
        return {
            ...
            "privileged_teacher_control_targets": bool(
                dataset.reference.get("privileged_teacher_control_targets", False)
            ),
        }
    ...
    if _EVIDENCE_REGISTRY_ROLES <= role_names:
        from .evidence.verified import verify_evidence_registry

        registry = verify_evidence_registry(root)
        return {
            "kind": "evidence_registry",
            "registry_id": registry.registry_id,
            "source_count": registry.source_count,
            "verified_count": registry.verified_count,
            "verification_failed_count": registry.verification_failed_count,
            "registered_artifact_count": registry.registered_artifact_count,
        }
