...
نمای مانیتور خود سرور CARLA نیز در این مسیر به‌صورت پیش‌فرض پشت خودروی اصلی
حرکت می‌کند تا اپراتور اجرای تست را ببیند. برای اجرای بدون این نمای تعقیب از
`--no-spectator-follow` استفاده کنید. این دوربین با دوربین RGB ورودی مدل یکی
نیست و وارد ورودی مدل نمی‌شود. چون CARLA ممکن است از موقعیت spectator برای
streaming نقشه استفاده کند، در benchmark آن را خاموش کنید مگر اینکه در پروتکل
آزمایش صریحاً فعال شده باشد.
