...
| Saved runs and player | [SavedRuns](../web/src/lib/components/SavedRuns.svelte), [server.py](../carla_vision/operator/server.py), [catalog.py](../carla_vision/operator/catalog.py) | `tests/test_operator.py`; actual playback/seek check | No |
